...
local_dir_root = "./Model/speech_UniASR_asr_2pass-ja-16k-common-vocab93-tensorflow1-offline"
target_sr = 44100
...
for file in filelist:
    ...
    line2 = savepth + "|" + character_name + "|JP|" + rec_result['text'] + "\n"
