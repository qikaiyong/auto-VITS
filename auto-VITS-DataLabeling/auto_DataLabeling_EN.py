...
local_dir_root = "./Model/speech_UniASR_asr_2pass-en-16k-common-vocab1080-tensorflow1-online"
target_sr = 44100
...
for file in filelist:
    ...
    annos_text = '[EN]' + annos_text.replace("\n", "") + '[ZH]'
    ...
    line2 = savepth + "|" + character_name + "|EN|" + rec_result['text'] + "\n"
    with open("./long_character_anno.txt", 'a', encoding='utf-8') as f:
        f.write(line1)
    with open(f"./speaker.list", 'a', encoding='utf-8') as f:
        f.write(line2)
    print(rec_result)
print("Done!\n")
